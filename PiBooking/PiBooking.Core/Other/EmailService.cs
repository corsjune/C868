...
namespace PiBooking.Core.Other
{
    ...
    public class EmailService: IEmailService
    {
        ...
        public bool SendMail(List<string> To, List<string> CC, List<string> BCC, string subject, string body)
        {
            ...
            To.ForEach(x => message.To.Add(new MailboxAddress(x)));
            CC.ForEach(x => message.Cc.Add(new MailboxAddress(x)));
            BCC.ForEach(x => message.Bcc.Add(new MailboxAddress(x)));
