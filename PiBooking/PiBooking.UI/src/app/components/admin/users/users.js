...
var Users = (function () {
    function Users(apiEndpoint, router) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        self = this;
                        result = confirm('Are you sure you wish to delete this user ?');
                        if (!result) return [3, 3];
                        return [4, this.apiEndpoint.destroyOne('user', id)
                                .catch(function (e) {
                    ...
                    case 1:
                        ...
                        _a = this;
                        return [4, this.apiEndpoint.find('user')];
                    case 2:
                        _a.users = _b.sent();
                        _b.label = 3;
                    case 3: return [2];
