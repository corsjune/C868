...
var UserDetails = (function () {
    function UserDetails(apiEndpoint, val, validator, myrouter) {
        var _this = this;
    ...
    UserDetails.prototype.bind = function () {
        ValidationRules
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.message = null;
                        self = this;
                        if (!(this.user.Id != null)) return [3, 2];
                        return [4, this.apiEndpoint.update('user', this.user.Id, this.user)];
                    case 1:
                        savedUser = _a.sent();
                        return [3, 4];
                    case 2: return [4, this.apiEndpoint.post('user', this.user)];
                    case 3:
                        savedUser = _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    UserDetails.prototype.validateWhole = function () {
        var _this = this;
    ...
    Object.defineProperty(UserDetails.prototype, "canSave", {
        get: function () {
            return this.cansave;
        },
        enumerable: true,
    ...
    UserDetails.prototype.activate = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4, this.apiEndpoint.find('user', params.id)];
                    case 1:
                        _a.user = _b.sent();
                        return [3, 3];
                    case 2:
