...
var Step2 = (function () {
    function Step2(stepsEnabled, sess, remote, val, validator, myrouter) {
        var _this = this;
    ...
    Step2.prototype.validateWhole = function () {
        var _this = this;
        this.validator.validateObject(this.currentOrder.Customer)
            .then(function (results) { return _this.stepsEnabled.step3.enabled = results.every(function (result) { return result.valid; }); });
    };
    Object.defineProperty(Step2.prototype, "canSave", {
        get: function () {
    ...
    Step2.prototype.canActivate = function () {
    ...
    Step2.prototype.Step3 = function () {
