...
var Step0 = (function () {
    function Step0(apiEndpoint, stepsEnabled, sess, val, validator, myrouter) {
    ...
    Step0.prototype.engineerChanged = function () {
        var _this = this;
        ...
        if (this.currentOrder.Engineer.EngineerID !== this.engineerID) {
            if (this.currentOrder.TimeSlots.length) {
                var result = confirm('Are you sure you wish to change this engineer. This will remove any selected timeslots.');
                if (result) {
                    this.currentOrder.Engineer = this.engineers.filter(function (x) { return x.EngineerID === _this.engineerID; }).pop();
    ...
    Step0.prototype.activate = function (params) {
    ...
    Step0.prototype.Step1 = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Step0 = __decorate([
        ...
        __metadata("design:paramtypes", [Rest, stepsEnabledService, sessionService, ValidationControllerFactory, Validator, Router])
    ], Step0);
    return Step0;
}());
export { Step0 };
