...
var Step3 = (function () {
    ...
    Step3.prototype.validateWhole = function () {
        var _this = this;
        this.validator.validateObject(this.currentOrder.Job)
            .then(function (results) { return _this.stepsEnabled.step4.enabled = results.every(function (result) { return result.valid; }); });
    };
    Object.defineProperty(Step3.prototype, "canSave", {
        get: function () {
    ...
    Step3.prototype.canActivate = function () {
